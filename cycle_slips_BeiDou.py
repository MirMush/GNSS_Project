...
# BeiDou B1-C/B3  (RINEX 2 maps BeiDou L1→B1, L2→B3)
BDS_F1 = 1575.42e6
BDS_F2 = 1268.52e6
...
def _lambdas(svid):
    ...
    if svid.startswith("C"):      # BeiDou SVIDs start with C
        return C_LIGHT / BDS_F1, C_LIGHT / BDS_F2
...
from sp3_ipp import read_sp3, build_ipp_table, plot_ipp_map, plot_ipp_time

SP3_FILE = "COD0MGXFIN_20241320000_01D_05M_ORB.SP3"
sat_pos = read_sp3(SP3_FILE)
ipp_df  = build_ipp_table(sat_pos, plot_data_gf, rnx)
plot_ipp_map(ipp_df)
plot_ipp_time(ipp_df)